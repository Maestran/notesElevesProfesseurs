 ...
 * @author franc
 */
public class updateEvaluation extends javax.swing.JFrame
{
    /**
     * Creates new form updateEvaluation
     */
    public updateEvaluation(Evaluation eval)
    {
        typeTF.setText(eval.getEvalType());
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateEvaluation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new updateEvaluation().setVisible(true);
            }
        });
    }
